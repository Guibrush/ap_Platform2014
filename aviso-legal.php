...
<?php
	...
	$title = "Aviso Legal";
	$description = "Explicación de la política legal ";
...
<?php require_once('php/head.php');?>
		...
		<section class="legalHeader u-separationMedium u-menuSeparation-desk">

			<div class="row">
				<div class="small-12 columns u-menuSeparation-mobile">
					<h1>Aviso Legal</h1>	
				</div>
			</div>
		...
		<section class="row u-separationBig">			

			<article class="small-12 columns u-separationMedium">
				<h3>Objeto</h3>
			...
			<article class="small-12 columns u-separationMedium">
				...
				<p>En cumplimiento de lo establecido en la ley orgánica 15/1999, de 13 de diciembre, de protección de datos de carácter personal, le informamos de que sus datos forman parte de un fichero propiedad de Dreamplanner S.L. debidamente notificado y registrado en la agencia de protección de datos, para la finalidad de nuestra relación con los usuarios, y la posibilidad del envío de comunicaciones comerciales. Asimismo, le informamos que puede ejercer los derechos de acceso, rectificación, cancelación y oposición en la dirección postal <!-- avda. Flota de indias 24, sevilla, mediante correo electrónico a info@hispalisfloat.com. --></p>
			...
			<article class="small-12 columns u-separationMedium">
				...
				<p>Para realizar cualquier tipo de observación respecto a posibles incumplimientos de los derechos de propiedad intelectual o industrial, así como sobre cualquiera de los contenidos del sitio web, puede hacerlo a través del siguiente correo electrónico <a href="mailto:info@dreamplanner.es">info@dreamplanner.es</a>.</p>				
			</article>
