...
<form data-abide="ajax" action="/comunidad-apuntate2.php" method="POST" id="publiForm">
	...
	<div class="row">
		...
		<div class="small-12 large-6 columns">
			<input class="Inputs" id="InputAdress" name="adress" type="text" placeholder="Dirección" required />
			<small class="error">Por favor, inroduce tu dirección.</small>			
		</div>
		...
		<div class="small-12 large-6 columns">
			<input class="Inputs" id="InputComercial" name="comercial" type="text" placeholder="El nombre de tu empresa o proyecto" required pattern="number" />
			<small class="error">Si estás en España, indicanos el nombre de tu empresa o proyecto.</small>			
		</div>
		...
		<div class="small-12 large-6 columns">
			<input class="Inputs" id="InputWeb" name="web" type="url" placeholder="http://" required />
			<small class="error">Indicanos tu página web</small>			
		</div>
		...
		<div class="row datosPersonales">
			<div class="small-12 columns datosPersonales-comunicaciones">
				...
				<input type="radio" name="publi" value="1" id="radioSi"><label for="radioSi">Sí</label>
		  		<input type="radio" name="publi" value="0" id="radioNo"><label for="radioNo">No</label>
			...
			<div class="small-12 columns datosPersonales-lopd">
				<p class="u-textSmall">
					...
					<input id="legalCheckbox" type="checkbox" name="clausula" maxlength="1">
						He leído 
