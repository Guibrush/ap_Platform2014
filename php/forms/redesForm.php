...
<form data-abide="ajax" action="/comunidad-apuntate2.php" method="POST" id="redesForm">
	...
	<div class="row">
		...
		<div class="row datosPersonales">
			<div class="small-12 columns datosPersonales-comunicaciones">
				...
				<p class="u-textSmall">Si te parece bien te enviaremos nuestras ofertas y promociones, por correo 
				electrónico, sms, etc. ¿Estás de acuerdo?</p>
